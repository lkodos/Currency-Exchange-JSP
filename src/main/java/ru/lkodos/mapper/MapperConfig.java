...
//            mapper.map(FullExchangeRate::getBaseCurrencyName, (dest, v) -> dest.getBaseCurrency().setFullName((String) v));
...
//            mapper.map(FullExchangeRate::getTargetCurrencyName, (dest, v) -> dest.getTargetCurrency().setFullName((String) v));
